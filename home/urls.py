...
urlpatterns = [
    ...
    path('dashboard/admin/projects/<int:project_id>/messages/', views.admin_project_messages, name='admin_project_messages'),
    ...
    path('dashboard/projects/<int:project_id>/invoice/', views.download_invoice, name='download_invoice'),
    path('dashboard/projects/<int:project_id>/messages/', views.client_project_messages, name='client_project_messages'),

    path('dashboard/projects/<int:project_id>/upload-file/', views.upload_project_file, name='upload_project_file'),
    path('dashboard/files/<int:file_id>/delete/', views.delete_project_file, name='delete_project_file'),

    path('dashboard/messages/<int:message_id>/edit/', views.client_edit_message, name='client_edit_message'),
    path('dashboard/messages/<int:message_id>/delete/', views.client_delete_message, name='client_delete_message'),
